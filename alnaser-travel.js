        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/alnasertravel/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.png">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [
    {
        title: 'عروض سوتشي',
        image_1: ['عروض-شركة-النصر/عروض-سوتشي/عرض-سوتشي-1.jpg', 'عرض سوتشي الجميلة - اقوى الاسعار'],
        image_2: ['عروض-شركة-النصر/عروض-سوتشي/عرض-سوتشي-2.jpg', 'عرض سوتشي الجميلة - اسعار منخفضة'],
        image_3: ['عروض-شركة-النصر/عروض-سوتشي/عرض-سوتشي-3.jpg', 'عرض سوتشي الجميلة - 8 أيام'],
        image_4: ['عروض-شركة-النصر/عروض-سوتشي/عرض-سوتشي-4.jpg', 'عرض سوتشي الجميلة - خاصة بفئة الصم'],
    },

    {
        title: 'عروض طرابزون',
        image_1: ['عروض-شركة-النصر/عروض-طرابزون/عرض-طرابزون-1.jpg', 'آيدر & زيجانا & همسكوي & اوزنجول'],
        image_2: ['عروض-شركة-النصر/عروض-طرابزون/عرض-طرابزون-2.jpg', 'آيدر & زيجانا & همسكوي & اوزنجول'],
        image_3: ['عروض-شركة-النصر/عروض-طرابزون/عرض-طرابزون-3.jpg', 'آيدر & زيجانا & همسكوي & اوزنجول'],
        image_4: ['عروض-شركة-النصر/عروض-طرابزون/عرض-طرابزون-4.jpg', 'آيدر & زيجانا & همسكوي & اوزنجول'],
    },
    
    {
        title: 'عروض تايلاند',
        image_1: ['عروض-شركة-النصر/عروض-تايلاند/عرض-تايلاند-1.jpg', 'بانكوك & بوكيت & كرابي'],
    },
    
    {
        title: 'عروض اذربيجان',
        image_1: ['عروض-شركة-النصر/عروض-اذربيجان/عرض-اذربيجان-1.jpg', 'عرض اذربيجان - باكو & غابالا'],
        image_2: ['عروض-شركة-النصر/عروض-اذربيجان/عرض-اذربيجان-2.jpg', 'عرض اذربيجان - باكو & غابالا'],
    },

    {
        title: 'عروض سريلانكا',
        image_1: ['عروض-شركة-النصر/عروض-سريلانكا/عرض-سريلانكا-1.jpg', 'كولومبو & كاندي & نوارليا & بنتوتا'],
    },


    {
        title: 'عروض اسطنبول',
        image_1: ['عروض-شركة-النصر/عروض-اسطنبول/عرض-اسطنبول-1.jpg', 'بورصا & سبانجا & البوسفور & بكركوي & ارتكوي & توزلا'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+97317593388?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/alnasertravel/${encodeURIComponent(src)}`;
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "شكرا شركة النصر على اتقانكم  بالعمل وعلى خدمتكم الجميله بارك الله فيكم وفي جهودكم الى الاعلى بإذن",
        stars: 5
    },
    {
        profileImage: "https://mughader.com/مكتب-للسفر-والسياحة/مكتب-للسفر-والسياحة-3.png",
        personName: "ناصر الهزاع",
        comment: "اشكر طاقم شركة النصر على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "نشكر شركة النصر على جهوده وتمنى له دائم التوفيق و والــــنــــجـــــاح",
        stars: 5
    },
    {
        profileLetter: "H",
        personName: "Hala Abdullah",
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا  شركة النصر للسياحة 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
        personName: "سامي الموسى",
        comment: "صراحه مجهود يشكر عليه من شركة النصر للسفر والسياحة ومن افضل الشركات الي حريصه علئ ادق التفاصيل شركه تلبي جميع احتيجاتك وعن تجربه اتكلم صراحه تعاملهم جدا راقي بجميع الاماكن والاوقات ❤️❤️",
        stars: 5
    },
];
...
function mughader_generateComments(comments) {
    ...
    comments.forEach(({ profileLetter, profileImage, personName, comment, stars }, index) => {
        ...
        if (profileImage) {
            ...
            img.alt = `مكتب سياحي - شركة النصر`;
            img.title = `مكتب سياحي - شركة النصر`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+97317593388";
